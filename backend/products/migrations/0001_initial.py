    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('packageQty', models.FloatField(default=1.0, help_text='Количество базовых единиц товара в упаковке', validators=[django.core.validators.MinValueValidator(0.0)], verbose_name='Кол-во ед товара в уп')),
                ...
                ('package', models.ForeignKey(help_text='Тип единицы измерения(например: бутылка или банка или кег)', on_delete=django.db.models.deletion.CASCADE, related_name='products', to='products.package', verbose_name='Тип единицы измерения')),
